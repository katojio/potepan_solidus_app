...
ActiveRecord::Schema.define(version: 20170506071375) do
  ...
  create_table "spree_promotion_code_batches", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "spree_wallet_payment_sources", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id",                             null: false
