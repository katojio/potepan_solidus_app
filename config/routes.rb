Rails.application.routes.draw do
  ...
  namespace :potepan do
    ...
    get :cart_page,                 to: 'sample#checkout_step_1'
    get :cart_page,                 to: 'sample#checkout_step_2'
    get :cart_page,                 to: 'sample#checkout_step_3'
    get :cart_page,                 to: 'sample#checkout_complete'
